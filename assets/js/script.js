...
// Dirubah 
const pengirim = "valdi";
const nomorWa = "62895702562362" // awalan nomor 0 harus di awalin 62
const textWa = "Ah bisa aja kamu"
const pesan = `hallo Rahma,Semangat ya dalam  menjalani aktivitas,ya walaupun lu lagi pms pasti bisa ko ngelewatin nya,itu sesuatu hal yg wajar buat cewe bre semua cewe jg ngalamin yg namanya pms,dan itu bisa bikin semua jd serba salah lah dan bikin mood naik turun jadi tetep semangat yaa KEEP STRONG!`;
